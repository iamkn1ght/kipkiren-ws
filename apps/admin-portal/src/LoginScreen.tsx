    ...
    <div className="lg-wrap">
      <form className="lg-card" onSubmit={onSubmit}>
        <div className="lg-brand">
          ...
          <div className="lg-sub">ADMIN</div>
          <div className="lg-scope">DELIVERY LEAD</div>
        </div>

        <h1 className="lg-title">Sign in</h1>
        <p className="lg-hint">Authorised staff only.</p>
        ...
        <div className="lg-foot">ws.kipkiren.co.ke · admin portal</div>
      </form>
    </div>
  );
}
