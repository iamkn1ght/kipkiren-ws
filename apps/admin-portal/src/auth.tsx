 ...
 *
 * Role gate: the admin portal is for delivery_lead and admin only. If a
 * client user ever logs in here we refuse them with a visible message
 * rather than showing the admin UI.
 */
...
const STORAGE_KEY = 'kws_admin_access_token';
 ...
 * with auth already wired. Kept small on purpose — tab components do their
 * own loading/error UI.
 */
