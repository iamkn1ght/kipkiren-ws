    ...
    <div className="lg-wrap">
      <form className="lg-card" onSubmit={onSubmit}>
        <div className="lg-brand">
          ...
          <div className="lg-sub">TASK VIEW · TECHNICAL DELIVERY</div>
        </div>

        <h1 className="lg-title">Sign in</h1>
        <p className="lg-hint">Access the tasks assigned to you.</p>
        ...
        <div className="lg-foot">ws.kipkiren.co.ke · technical delivery</div>
      </form>
    </div>
  );
}
