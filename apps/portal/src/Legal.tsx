...
const DOCS: Record<LegalDocId, LegalDoc> = {
  ...
  privacy: {
    ...
    blocks: [
      ...
      { h: '4. Who we share it with', body: ['We share data only with the processors that run the service:'], list: ['Supabase - application hosting and database (EU).', 'Cloudflare - DNS, edge and security for sites we manage.', 'Kipkiren Pay and Paystack - payment processing (M-Pesa and cards).', 'Our transactional email and SMS providers - to send you tickets, proformas and receipts.'] },
  ...
  sla: {
    ...
    blocks: [
      { h: 'Response times', body: ['We respond to tickets within the SLA of your plan, measured in business hours (Mon-Fri, 09:00-18:00 EAT):'], list: ['Starter - within 48 hours.', 'Growth - within 24 hours, with a named delivery lead.', 'Business - within 12 hours, with priority handling.'] },
      ...
      { h: 'Included vs billable', body: ['Each plan includes a block of change requests each month - content edits, small fixes and updates. Larger pieces of work are scoped on a proforma first and billed separately, always at your approval. Unused monthly allowance does not roll over.'] },
  ...
  faq: {
    ...
    blocks: [
      ...
      { h: 'How long does a build take?', body: ['Most Starter and Growth sites launch in two to four weeks from approval; larger Business builds run longer. You get a clear calendar and weekly demos - no mystery deliverables.'] },
