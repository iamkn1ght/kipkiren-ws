...
const clients: ClientSummaryRow[] = [
  { id: 'c1', business_name: 'Maridadi Press', contact_name: 'Amara Njoroge', email: 'amara@maridadi.co.ke', phone: '+254712000001', plan: 'Growth', retainer_plan_id: 'p-growth', monthly_fee_kes: 45000, included_hours: 10, hours_used_mtd: 7, open_tickets: 2, breached_tickets: 0, month_to_date_charges_kes: 61000, last_activity_at: hrs(-5), created_at: days(-120), status: 'active', invite_status: 'active' },
  { id: 'c2', business_name: 'Acacia Capital', contact_name: 'B. Otieno', email: 'b.otieno@acacia.co.ke', phone: '+254712000002', plan: 'Business', retainer_plan_id: 'p-business', monthly_fee_kes: 95000, included_hours: 20, hours_used_mtd: 22, open_tickets: 3, breached_tickets: 1, month_to_date_charges_kes: 128500, last_activity_at: days(-1), created_at: days(-64), status: 'active', invite_status: 'active' },
  { id: 'c3', business_name: 'Field Atlas', contact_name: 'M. Kamau', email: 'mkamau@fieldatlas.co.ke', phone: null, plan: 'Growth', retainer_plan_id: 'p-growth', monthly_fee_kes: 45000, included_hours: 10, hours_used_mtd: 4, open_tickets: 1, breached_tickets: 0, month_to_date_charges_kes: 45000, last_activity_at: days(-4), created_at: days(-12), status: 'active', invite_status: 'accepted' },
  { id: 'c4', business_name: 'Otieno & Co.', contact_name: 'J. Otieno', email: 'jotieno@otieno.co.ke', phone: '+254712000004', plan: 'Starter', retainer_plan_id: 'p-starter', monthly_fee_kes: 15000, included_hours: 5, hours_used_mtd: 2, open_tickets: 0, breached_tickets: 0, month_to_date_charges_kes: 15000, last_activity_at: days(-9), created_at: days(-2), status: 'active', invite_status: 'invited' },
];
